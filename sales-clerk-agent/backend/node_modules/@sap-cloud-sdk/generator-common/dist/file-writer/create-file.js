...
exports.defaultPrettierConfig = void 0;
...
function getFileExtension(fileName) {
    return (0, node_path_1.parse)(fileName).base.split('.').slice(1).join('.');
}
async function formatWithPrettier(fileName, content, prettierOptions) {
    ...
    if (parser) {
        try {
            return (0, prettier_1.format)(content, { ...prettierOptions, parser });
        }
        catch {
...
async function createFile(directoryPath, fileName, content, options) {
    ...
    try {
        ...
        return await writeFile((0, node_path_1.join)(directoryPath, fileName), adjusted, {
            encoding: 'utf8',
            flag: overwrite ? 'w' : 'wx'
        });
    }
