 ...
 * @internal
 */
export declare function parseAllServices(options: ParsedGeneratorOptions): Promise<VdmServiceMetadata[]>;
/**
 ...
 * @internal
 */
export declare function parseService(edmxServiceSpecPath: string, options: ParsedGeneratorOptions): Promise<VdmServiceMetadata>;
/**
 * @internal
 */
