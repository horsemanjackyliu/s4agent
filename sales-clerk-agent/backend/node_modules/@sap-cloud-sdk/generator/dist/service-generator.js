...
class ServiceGenerator {
    ...
    async generateService(edmxServiceSpecPath) {
        ...
        const serviceMetadata = (0, edmx_parser_1.readEdmxAndSwaggerFile)(edmxServiceSpecPath);
        ...
        const vdmServiceEntities = (0, edmx_to_vdm_1.isV2Metadata)(serviceMetadata.edmx)
            ? (0, edmx_to_vdm_1.getServiceEntitiesV2)(serviceMetadata, vdmServicePackageMetaData.className, this.options.skipValidation)
            : (0, edmx_to_vdm_1.getServiceEntitiesV4)(serviceMetadata, vdmServicePackageMetaData.className, this.options.skipValidation);
        return {
            ...vdmServicePackageMetaData,
            ...vdmServiceEntities,
            serviceOptions: {
                ...serviceOptions,
                basePath: (0, service_base_path_1.getBasePath)(serviceMetadata, serviceOptions)
            }
        };
    }
    getServicePackageMetaData(serviceMetadata, directoryName, edmxServiceSpecPath) {
        return {
            ...
            apiBusinessHubMetadata: (0, swagger_parser_1.apiBusinessHubMetadata)(serviceMetadata.swagger)
        };
    }
}
/**
