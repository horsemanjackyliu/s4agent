 ...
 * @internal
 */
function createPropertyFieldInitializerForEntity(prop, fieldBuilderName = '_fieldBuilder', service) {
    ...
    return `${fieldBuilderName}.buildEdmTypeField('${prop.originalName}', '${prop.edmType}', ${prop.nullable}${prop.precision !== undefined &&
        isPrecisionAwareEdmType(prop.edmType) &&
        service?.oDataVersion === 'v4'
        ? `, ${prop.precision}`
        : ''})`;
}
function isPrecisionAwareEdmType(value) {
