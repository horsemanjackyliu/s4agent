 ...
 * @internal
 */
function getOperationParameters(edmxOperationImport, edmxParameters, swaggerDefinition, formatter) {
    return edmxParameters.map(p => {
        ...
        return {
            originalName: p.Name,
            parameterName: formatter.originalToParameterName(edmxOperationImport.Name, p.Name),
