...
function generateFunctionImportsV2(serviceMetadata, serviceName, entities, complexTypes, formatter) {
    ...
    return (edmxFunctionImports
        ...
        return {
            ...(0, common_1.transformOperationBase)(f, f.Parameter, 'function', swaggerDefinition, formatter, undefined // oData v2 does not have bound functions
            ),
            httpMethod,
            returnType: (0, common_1.parseOperationReturnType)(f.ReturnType
